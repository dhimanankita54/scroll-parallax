...
export const Parallax = () => {
  ...
  const h2_2Ref = useRef(null);
  const h2_3Ref = useRef(null);
  const h2_4Ref = useRef(null);
  const h2_5Ref = useRef(null);
  const h2_6Ref = useRef(null);
  const h3_1Ref = useRef(null);
  const h3_2Ref = useRef(null);
  const h3_3Ref = useRef(null);
  const h3_4Ref = useRef(null);
  const h3_5Ref = useRef(null);
  ...
  useEffect(() => {
    ...
    scene1.to(h3Ref?.current, { y: 1.7 * speed, x: 1.2 * speed }, 0.03);
    scene1.to(h4Ref?.current, { y: 3 * speed, x: 1 * speed }, 0.03);
    scene1.to(h5Ref?.current, { y: 2 * speed, x: 1 * speed }, 0.03);
    scene1.to(h6Ref?.current, { y: 2.3 * speed, x: -2.5 * speed }, 0);
    scene1.to(h7Ref?.current, { y: 5 * speed, x: 1.6 * speed }, 0);
    scene1.to(h8Ref?.current, { y: 3.5 * speed, x: 0.2 * speed }, 0);
    scene1.to(h9Ref?.current, { y: 3.5 * speed, x: -0.2 * speed }, 0);

    //animate text
    scene1.to(infoRef?.current, { y: 8 * speed }, 0);
    ...
    gsap.fromTo(
      ...
      { opacity: 1 },
      {
        ...
        scrollTrigger: {
          ...
          scrub: 4,
          onEnter: function () {
            gsap.to(birdRef?.current, { scaleX: 1, rotation: 0 });
          },
          onLeave: function () {
    ...
    clouds.to(cloud1Ref?.current, { x: 500 }, 0);
    clouds.to(cloud2Ref?.current, { x: 1000 }, 0);
    clouds.to(cloud3Ref?.current, { x: -1000 }, 0);
    clouds.to(cloud4Ref?.current, { x: -700, y: 25 }, 0);
    ...
    //bg change
    sun.to(sunRef?.current, { attr: { offset: "0.15" } }, 0.0);
    ...
    scene2.fromTo(h2_2Ref?.current, { y: 500 }, { y: 0 }, 0.1);
    scene2.fromTo(h2_3Ref?.current, { y: 700 }, { y: 0 }, 0.1);
    scene2.fromTo(h2_4Ref?.current, { y: 700 }, { y: 0 }, 0.2);
    scene2.fromTo(h2_5Ref?.current, { y: 800 }, { y: 0 }, 0.3);
    scene2.fromTo(h2_6Ref?.current, { y: 900 }, { y: 0 }, 0.3);
    ...
    sun2.to(sunRef?.current, { attr: { offset: "0.6" } }, 0);
    sun2.to("#bg_grad stop:nth-child(2)", { attr: { offset: "0.7" } }, 0);
    sun2.to(sunRef?.current, { attr: { "stop-color": "#ffff00" } }, 0);
    ...
    gsap.set(scene3Ref.current, { y: 580, visibility: "visible" });
    ...
    sceneTransition.to(
      h2_1Ref.current,
      { y: -580, scale: 1.5, transformOrigin: "50% 50%" },
      0
    );
    sceneTransition.to(bgGradRef.current, { attr: { cy: "-80" } }, 0.0);
    sceneTransition.to(bg2Ref.current, { y: 0 }, 0);
    ...
    //Hills motion
    scene3.fromTo(h3_1Ref.current, { y: 300 }, { y: -550 }, 0);
    scene3.fromTo(h3_2Ref.current, { y: 800 }, { y: -550 }, 0.03);
    scene3.fromTo(h3_3Ref.current, { y: 600 }, { y: -550 }, 0.06);
    scene3.fromTo(h3_4Ref.current, { y: 800 }, { y: -550 }, 0.09);
    scene3.fromTo(h3_5Ref.current, { y: 1000 }, { y: -550 }, 0.12);
    ...
    scene3.to(bg2GradRef.current, { attr: { cy: 600 } }, 0);
    scene3.to(bg2GradRef.current, { attr: { r: 500 } }, 0);

    /*   falling star   */
    gsap.to(fstarRef.current, {
      x: -700,
      y: -250,
      ease: "power4.out",
      scrollTrigger: {
        ...
        scrub: 5,
        onEnter: function () {
          gsap.set(fstarRef.current, { opacity: 1 });
        },
        onLeave: function () {
          gsap.set(fstarRef.current, { opacity: 0 });
        },
      },
    });
  ...
  return (
    <>
      ...
      >
        <defs>
          ...
          <radialGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0.1" stop-color="#F5C54E" id="sun" ref={sunRef} />
        ...
        {/* <!-- SCENE 2 --> */}
        <g id="scene2">
          <g id="bats" ref={batsRef} style={{ opacity: 0 }}>
            <path
        ...
        {/* <!-- Scene 3 --> */}
        <g id="scene3" ref={scene3Ref} style={{ visibility: "hidden" }}>
          <rect
            ref={bg2Ref}
            id="bg2"
            y="-59.8"
          ...
          <g id="stars" ref={starRef} fill="#fff" style={{ opacity: 0 }}>
      ...
      <div class="scrollElement" ref={scrollTriggerRef}></div>
